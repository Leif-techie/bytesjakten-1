...
export async function getAdminStats() {
  const [
    ...
    electricityUserCount,
    activeElectricityUsers,
    reminderCount,
    activeReminders,
    campaignCount,
    activeCampaigns,
    ...
    electricityCampaignCount,
    activeElectricityCampaigns,
    meta,
  ] = await Promise.all([
    db.user.count(),
    ...
    db.electricityUser.count(),
    db.electricityUser.count({ where: { active: true } }),
    db.reminderSubscription.count(),
    db.reminderSubscription.count({ where: { active: true } }),
    db.campaign.count(),
    db.campaign.count({ where: { active: true } }),
    db.broadbandCampaign.count(),
    db.broadbandCampaign.count({ where: { active: true } }),
    db.electricityCampaign.count(),
