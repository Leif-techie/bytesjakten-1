...
**Bredband:** Separat vertikal på `/bredband` för **mobilt bredband / 5G-hemma** (inte stadsnätsfiber). Egen tabell `BroadbandUser` (e-post, operatör, slutdatum, hastighet, nät 4G/5G). Registrering via `/api/broadband/register` + bekräftelsemejl. Ingen admin/kampanjmatchning ännu. Mobilflödet är oförändrat.
