...
if (-not (Test-Path ".env")) {
    ...
    Write-Host "VIKTIGT: Redigera .env och fyll i MAILEROO_API_KEY, ADMIN_SECRET m.m." -ForegroundColor Yellow
}
...
Write-Host "  1. Redigera .env (MAILEROO_API_KEY, ADMIN_SECRET, EMAIL_FROM)"
